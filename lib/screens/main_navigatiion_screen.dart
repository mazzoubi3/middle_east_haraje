...
import 'package:middle_east_haraje/screens/home_screen.dart';
import 'package:middle_east_haraje/screens/post/my_post_screen.dart';
import 'package:middle_east_haraje/screens/profile_screen.dart';
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  List pages = [
    const HomeScreen(),
     CategoryListScreen(isForForm: true),
    const MyPostScreen(),
    const ProfileScreen(),
  ];
        ...
        items: [
          ...
          DotNavigationBarItem(
            icon: Container(
              ...
              padding: const EdgeInsets.all(10),
              child: Icon(
                _index == 2 ? CupertinoIcons.heart_fill : CupertinoIcons.heart,
